                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-block">
                            ...
                            <input name="gender" type="radio" class="input-radio" value="nam" checked="checked" style="width: 10%"><span style="margin-right: 10%">Nam</span>
                            <input name="gender" type="radio" class="input-radio"  value="nữ" style="width: 10%"><span>Nữ</span>
