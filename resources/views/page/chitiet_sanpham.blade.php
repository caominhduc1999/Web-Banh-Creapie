                            ...
                            <div class="single-item-body">
                                ...
                                <p class="single-item-price">
                                    ...
                                    @elseif($sanpham->promotion_price == 0)
                                        <span class="flash-sale" style="color: black;">{{number_format($sanpham->unit_price)}} đồng</span>
                                    @endif
                                </p>
                            </div>
                                    ...
                                    <div class="single-item-body">
                                        ...
                                        <p class="single-item-price">
                                            ...
                                            @elseif($sptt->promotion_price == 0)
                                                <span class="flash-sale" style="color: black;">{{number_format($sptt->unit_price)}} đồng</span>
                                            @endif
                                        </p>
                                    </div>
